          ...
          <div className="border-b border-gray-200 dark:border-slate-800 pb-5 mb-8 flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="mt-4 md:mt-0 flex flex-wrap gap-2">
              ...
              <div className="inline-flex items-center">
                <span className="mr-3 text-sm font-medium text-gray-700">24h</span>
                <Switch
                  checked={!use24Hour}
                  onCheckedChange={(checked) => setUse24Hour(!checked)}
                  id="timeFormatToggle"
                />
                <span className="ml-3 text-sm font-medium text-gray-700">12h</span>
              </div>
            </div>
          </div>
          ...
          {isLoading && (
            <div className="flex justify-center items-center h-60">
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-500">Loading timezones...</p>
              </div>
            </div>
          )}
